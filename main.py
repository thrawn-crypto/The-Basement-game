...
def makeMove(board, chests, x, y):
    ...
    if smallestDistance == 0:
        ...
        chests.remove([x, y])
        return 'You have found a glitched treasure chest!'
    else:
...
def showInstructions():
    print('''Instructions:
Hello there Adventurer, you have entered The Basement, your not sure how you ended up here.
It's dark with a thick fog that makes it impossible to see, But you've heard rumors since childhood
of strange treasures being kept in this strange land.

As you start your search you realise all you have with you is a cheap sonar machine that 
can only tell distance and not direction. Theres no telling how long it will last.

Enter the coordinates to drop a sonar device. The Basement map will be marked with
...
012345678901234567890123456789012
1 2 3
(In the real game, the chests are not visible in the basement.)
...
while True:
    ...
    while sonarDevices > 0:
        ...
        if moveResult == False:
            ...
            if moveResult == 'You have found a glitchy treasure chest!':
        ...
        if len(theChests) == 0:
            print('You have found all the glitchy treasure chests! Congratulations and good game!')
            break

        sonarDevices -= 1

    if sonarDevices == 0:
        print('We\'ve run out of sonar devices! Now we have to turn around and head')
